...
public class InStorePackagePrice implements Serializable
{
    ...
    private final static long serialVersionUID = 2989974944483625866L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public InStorePackagePrice() {
    }
     ...
     * @param currencyUnit
     */
    public InStorePackagePrice(Double price, String currencyUnit, String currencyUnitSymbol) {
        super();
        this.price = price;
