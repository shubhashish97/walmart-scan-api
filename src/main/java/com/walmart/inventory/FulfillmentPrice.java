...
public class FulfillmentPrice implements Serializable
{
    ...
    private final static long serialVersionUID = 6889157211069810570L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public FulfillmentPrice() {
    }
     ...
     * @param currencyUnit
     */
    public FulfillmentPrice(Double price, String currencyUnit, String currencyUnitSymbol) {
        super();
        this.price = price;
